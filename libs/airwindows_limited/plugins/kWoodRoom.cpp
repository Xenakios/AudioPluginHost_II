...
bool kWoodRoom::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool kWoodRoom::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
