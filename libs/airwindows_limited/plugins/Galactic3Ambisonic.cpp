...
{
    return new Galactic3(audioMaster);
}
...
void Galactic3::getParameterName(VstInt32 index, char *text)
{
    ...
    {
    case kParamA:
        vst_strncpy(text, "Replace", kVstMaxParamStrLen);
        break;
    case kParamB:
        vst_strncpy(text, "Brightns", kVstMaxParamStrLen);
        break;
    case kParamC:
        vst_strncpy(text, "Detune", kVstMaxParamStrLen);
        break;
    case kParamD:
        vst_strncpy(text, "Derez", kVstMaxParamStrLen);
        break;
    case kParamE:
        vst_strncpy(text, "Bigness", kVstMaxParamStrLen);
        break;
    case kParamF:
...
void Galactic3::getParameterDisplay(VstInt32 index, char *text)
{
    ...
    case kParamB:
        ...
        break;
    case kParamC:
        float2string(C, text, kVstMaxParamStrLen);
        break;
    case kParamD:
        float2string(D, text, kVstMaxParamStrLen);
        break;
    case kParamE:
        float2string(E, text, kVstMaxParamStrLen);
        break;
    case kParamF:
...
{
    vst_strncpy(name, "Galactic3", kVstMaxProductStrLen);
    return true;
}
...
{
    vst_strncpy(text, "airwindows Galactic3", kVstMaxProductStrLen);
    return true;
}
