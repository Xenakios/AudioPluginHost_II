...
bool CrunchCoat::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool CrunchCoat::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
