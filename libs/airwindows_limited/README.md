AirWindows (c) Chris Johnson. AirWindows Consolidated (c) Paul Walker.

https://github.com/airwindows
...
the 8 reverb output taps from the algorithm into 8 spherical positions. These positions are currently hardcoded
but it might of course be desirable to have alternative patterns or even allow changing the positions
via plugin parameters.

The ambisonic order can be
