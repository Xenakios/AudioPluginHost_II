...
const EasingMapping easing_table[] = {
    ...
    {"Quadratic Ease InOut", QuadraticEaseInOut},

    {"Cubic Ease In", CubicEaseIn},
    {"Cubic Ease Out", CubicEaseOut},
    {"Cubic Ease InOut", CubicEaseInOut},

    {"Quartic Ease In", QuarticEaseIn},
    {"Quartic Ease Out", QuarticEaseOut},
    {"Quartic Ease InOut", QuarticEaseInOut},

    {"Quintic Ease In", QuinticEaseIn},
    {"Quintic Ease Out", QuinticEaseOut},
    {"Quintic Ease InOut", QuinticEaseInOut},

    {"Sine Ease In", SineEaseIn},
    {"Sine Ease Out", SineEaseOut},
    {"Sine Ease InOut", SineEaseInOut},

    {"Circular Ease In", CircularEaseIn},
    {"Circular Ease Out", CircularEaseOut},
    {"Circular Ease InOut", CircularEaseInOut},

    {"Exponential Ease In", ExponentialEaseIn},
    {"Exponential Ease Out", ExponentialEaseOut},
    {"Exponential Ease InOut", ExponentialEaseInOut},

    {"Elastic Ease In", ElasticEaseIn},
    {"Elastic Ease Out", ElasticEaseOut},
    {"Elastic Ease InOut", ElasticEaseInOut},

    {"Back Ease In", BackEaseIn},
    {"Back Ease Out", BackEaseOut},
    {"Back Ease InOut", BackEaseInOut},

    {"Bounce Ease In", BounceEaseIn},
    {"Bounce Ease Out", BounceEaseOut},
    {"Bounce Ease InOut", BounceEaseInOut},
...
struct EasingLUTS
{
    ...
    static const size_t numFunctions = 33;
